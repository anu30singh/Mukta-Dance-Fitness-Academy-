...
import FounderAward2 from '../assets/FounderImage2.jpeg'; // Replace with the actual image path
import FounderAward3 from '../assets/FounderImage3.jpeg'; // Replace with the actual image path
